...
class Management(models.Model):
    ...
    assessment_date = fields.Datetime(
        string="Datum",
        store=True,
        related="assessment_id.date_begin")