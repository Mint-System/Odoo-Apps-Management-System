{
    ...
    "data": [
        ...
        "views/mgmt_hazard.xml",
        "views/mgmt_hazard_history.xml",
        "views/mgmt_action.xml",
        "views/mgmt_assessment.xml",
        "views/mgmt_risk.xml",
        ...
        "data/mgmt.hazard.probability.csv",
        "data/mgmt.hazard.severity.csv",
        "data/mgmt.document.category.csv",
